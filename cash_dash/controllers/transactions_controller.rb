...
get '/transactions' do
  ...
  @pretty_total = Utilities.display_pounds_pence(total)
  @months = Month.all()
  @years = Transaction.return_years()
  @month = Date.today.month
  @year = Date.today.year.to_s
  budget = ( Transaction.number_of_months_spending() * Budget.all.amount ) - total
  @budget = Utilities.display_pounds_pence(budget)
...
get '/transactions/:id/edit' do
  ...
  @pretty_total = Utilities.display_pounds_pence( @transaction.amount.to_i )
  @pretty_total[0] = ""
...
post '/transactions/month-year' do
  ...
  @year = params['year']
  @budget = Utilities.display_pounds_pence( Budget.all.amount - total )
  erb( :"/transactions/index")
end
